...
public class TreeNodeUtils {
    ...
    private static TreeNode buildBalanceTreeByList(int[] array, int low, int high) {
    ...
    public static List<Integer> traversalTree(TreeNode root, TreeTraversalType traversalType) {
...
//    public static TreeNode buildTreeNode(List<String> nodes) {
...
//            String nodeVal = nodes.get(idx);
//            if (StringUtils.equals(nodeVal, "null")) {
//                continue;
//            }
//            TreeNode node = new TreeNode(NumberUtils.toInt(nodeVal));
//            if (root == null) root = node;
//            if (idx * 2 < nodes.size() && !StringUtils.equals(nodes.get(idx * 2), "null")) {
//
//            }
//
//        }
